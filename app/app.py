...
app.config.update(dict(
    ...
    # SQLALCHEMY_DATABASE_URI='mysql+mysqlconnector://username:password@0.0.0.0:13306/user',
    SQLALCHEMY_DATABASE_URI='mysql+mysqlconnector://root:test@user_db:3306/user',
))
